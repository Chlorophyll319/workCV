...
export const experienceData: ExperienceItem[] = [
  {
    ...
    type: 'work',
    title: '全端工程師',
    organization: '閃電通國際股份有限公司',
    startDate: '2025/11',
    endDate: '2026/4',
    description:
      '在 10 人 eSIM 新創擔任團隊唯一 Web 工程師，獨立負責主產品電商前台、內部 ERP 系統的完整開發，以及 AI 客服系統的技術評估與規格文件。主導早期技術選型（前後端、App、資料庫、GitHub 權限規範），設計 API 代理層避免後端位址暴露，路由架構預先支援台灣、日本、英語系三個市場。獨立實作完整訪客購買流程：Email OTP → 優惠碼 → 台灣電子發票 → 串接綠界 ECPay；首頁商品資料快取供結帳頁共用（5 分鐘，與後端設定對齊），並加入前端防重複送出控制。另結合設計背景執行競品 UX 分析（Airalo、Trifa、手創漫遊），回饋至產品介面決策。',
    skills: [
      'Next.js 16',
      'React 19',
      'TypeScript',
  ...
  },
  {
    ...
    startDate: '2014/9',
    endDate: '2017/6',
    description: '主修廣告設計，奠定視覺設計與美感基礎，是日後設計思維與介面敏感度的起點。',
    skills: ['視覺設計', '廣告設計', '美感訓練'],
    status: 'completed',
    gitCommitStyle: 'feat(education): 廣告設計科畢業',
  },
];
