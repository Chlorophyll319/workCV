...
export const experienceData: ExperienceItem[] = [
  ...
  },
  {
    ...
    startDate: '2025/10',
    description:
      'Git 學習輔助工具，提供指令產生器、速查表、情境導向、歷史記錄四個功能頁面。危險指令加二次確認保護，歷史記錄以 Pinia + persistedstate 本機持久化。',
    skills: [
      'Vue 3',
      'Vite',
      'TypeScript',
  ...
  },
  {
    ...
    startDate: '2025/9',
    description:
      '一頁式個人履歷網站，歷經大改版（VSCode 風格 → 報紙排版風格），持續迭代優化。整合 SEO、Open Graph、JSON-LD，GitHub Actions 自動部署至 GitHub Pages。',
    skills: [
      'Nuxt 3',
      'Vue 3',
      'TypeScript',
  ...
  },
  {
    ...
    endDate: '2025/9',
    description:
      '獨立開發具備前後台管理功能的課程資訊網站，整合 Markdown + Mermaid 語法渲染。採用 MVC 架構、RESTful API，設計 ERD，實作 JWT + Passport.js 登入驗證。',
    skills: [
      'Vue 3',
      'Tailwind CSS',
      'daisyUI',
  ...
  },
  {
    ...
    startDate: '2025/5',
    description:
      '串接政府開放資料的多功能 LINE 聊天機器人，9 個功能模組持續擴充中。設計 BaseBot 共用基底類別，分層架構（routes → bots → services → adapters）職責清楚分離。',
    skills: [
      'Node.js',
      'Express.js',
      'LINE Messaging API',
