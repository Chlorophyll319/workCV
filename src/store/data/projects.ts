...
export const projects: Project[] = [
  {
    ...
    name: '多功能 LINE 聊天機器人',
    type: '聊天機器人',
    description: '串接政府開放資料的多功能 LINE 聊天機器人，9 個功能模組持續擴充中。設計 BaseBot 共用基底類別，每個功能模組繼承同一套介面（canHandle / handle / getHelpInfo）；messageRouter 遍歷清單自動分發，新增功能不需修改路由層。',
    techStack: ['Node.js', 'Express.js', 'LINE Messaging API', '政府開放資料 API', 'MongoDB', 'Mongoose'],
  ...
  },
  {
    ...
    name: '泰山職訓課程學員分享網',
    type: '全端專案',
    description: '獨立開發具備前後台管理功能的課程資訊網站，提供訓練單位介紹、學員成果展示、FAQ 系統與文章內容管理，並整合 Markdown 與 Mermaid 語法渲染。採用 MVC 架構設計與 RESTful API，設計資料表結構並繪製 ERD，實作 JWT + Passport.js 登入驗證機制。',
    techStack: ['Vue 3', 'Vite', 'Tailwind CSS', 'daisyUI', 'PrimeVue', 'Node.js', 'Express.js', 'MongoDB', 'Mongoose', 'JWT', 'Passport.js'],
  ...
  },
  {
    ...
    name: 'Evenly - 個人履歷網站',
    type: '前端專案',
    description: '一頁式個人履歷網站，設計歷經大改版（初版 VSCode 風格 → 現版報紙排版風格），持續迭代優化。使用 Nuxt 3（SPA mode）搭配 Vue 3、TypeScript、Tailwind CSS v4，整合 Pinia 狀態管理，建立 SEO 機制與 GitHub Actions 自動部署。',
    techStack: ['Nuxt 3', 'Vue 3', 'TypeScript', 'Tailwind CSS v4', '@nuxt/ui', 'Pinia', 'Iconify', 'GitHub Actions'],
  ...
  },
  {
    ...
    type: '前端工具',
    description: 'Git 學習輔助工具，提供指令產生器、速查表、情境導向、歷史記錄四個功能頁面。支援 cherry-pick、tag、remote、log 等多種指令類型，危險指令加二次確認與 Enter 快捷鍵；速查表支援分類 Tab 篩選與指令範例展開。',
    techStack: ['Vue 3', 'Vite', 'TypeScript', 'Tailwind CSS v4', 'daisyUI v5', 'Pinia', 'pinia-plugin-persistedstate', 'vee-validate', 'yup', 'unplugin-vue-router'],
